...
export default function LessonsPage() {
  ...
  return (
    <div className="flex-1 flex flex-col gap-6 min-h-0 relative">
      <TutorialGuide variant="admin" steps={tutorialSteps} storageKey="creosim_tutorial_admin_lessons" />
      {error && (
      ...
      {notice ? (
        <div
          className={`keep-selection rounded-2xl px-6 py-4 text-sm font-semibold shadow-sm shrink-0 border ${notice.kind === "success"
                      ...
                      return (
                        ...
                        >
                          <td className="px-6 py-4 relative">
                            ...
                            <div className="flex items-center gap-4">
                              <div
                                className={`w-9 h-9 rounded-full flex items-center justify-center text-[11px] font-black shrink-0 transition-colors ${isSelected
                              ...
                              <span
                                className={`font-extrabold text-[13px] ${isSelected ? "text-[#0B1B3D] dark:text-white" : "text-slate-600 dark:text-slate-300"
                                  }`}
                              >
                                {item.module_code}
                              </span>
                          ...
                          <td className="px-6 py-4">
                            <p
                              className={`font-bold text-[13px] truncate max-w-[240px] ${isSelected ? "text-[#0B1B3D] dark:text-white" : "text-slate-600 dark:text-slate-300"
                                }`}
                            >
                              {item.module_title}
                            </p>
                ...
                <div className="p-6 overflow-y-auto custom-scrollbar flex-1">
                      ...
                      {selectedModuleLessons.map((lesson, index) => {
                        ...
                        return (
                          <div
                            ...
                            className={`rounded-xl border px-3 py-3 cursor-pointer transition-colors ${isSelected
                  ...
                  {selectedLesson ? (
                    <div className="border border-slate-200 dark:border-slate-700/50 rounded-2xl p-4 flex flex-col gap-4 relative">
                      ...
                      <div className="flex items-center gap-4">
                        <div
                          className={`w-12 h-12 rounded-xl shrink-0 flex items-center justify-center ${(selectedLesson.resolved_url || selectedLesson.url || "").trim().length > 0
