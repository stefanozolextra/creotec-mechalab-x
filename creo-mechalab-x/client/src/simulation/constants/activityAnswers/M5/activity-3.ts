import activity3Diagram from '../../../../assets/ladder-diagrams/M5/activity-5.3.png';
...
export const activity3Answer: ActivityAnswerDefinition = {
  routeId: '3',
  title: 'Two-Cylinder Sequence A+ B+ A- B-',
  instruction: 'Complete the cascade wiring so cylinder A extends first, triggers cylinder B, then both cylinders return through the limit-switch and relay interlocks shown on the diagram.',
  ...
  rule: {
    ...
    customConnections: [
      ...
      [
        [RELAY_PIN_IDS.relay3.terminal1, RELAY_PIN_IDS.relay2.terminal10],
      ...
      [RELAY_PIN_IDS.solenoid1.ls1No, RELAY_PIN_IDS.solenoid2.bMinusPositive],
